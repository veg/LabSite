          ...
          {theme === '2020s' ? (
            <div className="max-w-4xl mx-auto flex flex-col items-center">
              <div className="mb-12">
                 ...
                 <p className="text-xl text-slate-400">Discover the research and tools of the ACME Laboratory.</p>
              </div>
              ...
              <div className="mt-12 w-full max-w-2xl bg-ai-sidebar border border-white/10 p-4 rounded-2xl flex items-center gap-4 shadow-xl">
