...
export function ThemeProvider({ children }) {
  ...
  useEffect(() => {
    ...
    document.body.classList.remove('theme-profdr', 'theme-geocities', 'theme-y2k', 'theme-80s', 'theme-90s', 'theme-2000s', 'theme-2010s', 'theme-2020s', 'theme-myspace', 'theme-typewriter', 'theme-bios', 'theme-macos', 'theme-zelda', 'theme-mario', 'crt');
