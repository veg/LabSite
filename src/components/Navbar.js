...
export default function Navbar() {
  return (
    <nav className="bg-black border-b-4 border-retro-green p-4 sticky top-0 z-50 overflow-hidden">
      {/* Silly Animation Layer */}
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="animate-chase flex items-center h-full gap-8">
          {/* Banana */}
          <svg width="24" height="24" viewBox="0 0 24 24" className="text-retro-amber opacity-50">
          ...
          {/* DataMonkey */}
          <div className="animate-monkey-bounce flex flex-col items-center">
             <svg width="32" height="32" viewBox="0 0 32 32" className="text-retro-green opacity-40">
                {/* Body */}
                ...
                {/* Tail */}
                <rect x="2" y="22" width="6" height="2" fill="currentColor" className="animate-tail" />
             </svg>
             <span className="text-[6px] font-mono text-retro-green opacity-30 mt-1">DATAMONKEY_v1.0</span>
          </div>
        </div>
      </div>
